...
const FIELDS = [
  ...
  { key: 'schoolName12th', label: 'School Name (12th)', type: 'text', required: false, placeholder: 'Previous School' },
  { key: 'stream12th', label: 'Stream (12th)', type: 'text', required: false, placeholder: 'e.g. Maths' },
  { key: 'classFees12th', label: 'Class Fees (12th)', type: 'number', required: false, placeholder: 'Fees in ₹' },
  { key: 'marks10', label: '10th %', type: 'number', required: false, placeholder: 'Max 100' },
  { key: 'marks11', label: '11th %', type: 'number', required: false, placeholder: 'Max 100' },
      ...
      async () => {
        ...
        try {
          const payload = students.map((s) => ({
            ...
            classFees12th: s.classFees12th ? Number(s.classFees12th) : 0,
            marks10: s.marks10 ? Number(s.marks10) : 0,
            marks11: s.marks11 ? Number(s.marks11) : 0,
          }));
          ...
          {!selectedFile ? (
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-5">
                ...
                >
                  {loading ? (
                    <><Loader color="white" size="xs" /> Uploading...</>
                  ) : (
      ...
      {activeTab === 'manual' && (
        <div className="animate-slide-in">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-5">
            ...
            >
              {loading ? (
                <><Loader color="white" size="xs" /> Saving...</>
              ) : (
