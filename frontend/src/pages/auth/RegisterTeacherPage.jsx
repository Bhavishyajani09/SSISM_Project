  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8 animate-fade-in pb-20">
      <div className="mb-8">
        ...
        <p className="text-slate-500 text-sm mt-1">Add a new verifier to the system.</p>
        <p className="text-gray-500 mt-1">Manage system accounts and monitor verifier activity.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 overflow-hidden">
            <h1 className="text-2xl font-bold text-slate-900">Register Verifier</h1>
            <p className="text-xs text-slate-400">Basic information for the new verifier.</p>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Verifier Name</label>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    <option value="teacher">Verifier</option>
              ...
              >
                {isLoading ? 'Registering Verifier...' : 'Register Verifier'}
              </button>
            </form>
          </div>
        </div>
                      ...
                      <tr key={u.id} className="group hover:bg-gray-50/50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <span className={`px-2.5 py-1 rounded-lg text-[10px] font-black uppercase ${u.role === 'admin' ? 'bg-indigo-50 text-indigo-600' : 'bg-brand-50 text-brand-600'}`}>
                            {u.role === 'teacher' ? 'Verifier' : u.role}
                          </span>
                        </td>
